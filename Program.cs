        ...
        private static async void onMessageHandler(object sender, MessageEventArgs e)
        {
            ...
            switch (msg.Text)
            {
                ...
                case "Как поменять натяг?":
                    Thread.Sleep(500);
                    await client.SendTextMessageAsync(msg.Chat.Id, "Перейдите в экран 'Macro' найдите параметр под номером '511'  и измените его ." +
                ...
                case "Как исправить конусность?":
                    Thread.Sleep(500);
                    await client.SendTextMessageAsync(msg.Chat.Id, "Перейдите в экран 'Macro' найдите параметр под номером '537'  и измените его " +
                ...
                case "Как поменять гребенку?":
                    Thread.Sleep(500);
                    await client.SendTextMessageAsync(msg.Chat.Id, "Открутите прижимной винт шестигранным ключем на 5 , продуйте посадочное место под гребенку и установите новую прижав ее в обратную от шпинделя сторону");
                    break;
